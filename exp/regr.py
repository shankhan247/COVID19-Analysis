...
poly = PolynomialFeatures(degree=1) # define polynomial
...
plt.xlabel('Total Cases on a Given Day')
plt.ylabel('Predicted Total Cases After 1 Day')
plt.title('Relationship Between Total and Predicted COVID-19 Cases Within US')
plt.grid()
plt.show()
...
plt.ylabel('Total Corona Cases')
plt.title('Total Known/Predicted COVID-19 Cases Within the US Per Day')
plt.grid()
plt.show()
...
plt.xlabel('Number of Days Since Jan 22, 2020')
plt.ylabel('Rate of Corona Cases')
plt.title('Rate of Known/Predicted COVID-19 Cases Within the US Per Day')
plt.grid()
plt.show()
